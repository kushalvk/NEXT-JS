    ...
    const courses = [
        {
            ...
            price: '$49.99',
            image: 'https://images.unsplash.com/photo-1633356122544-f1348ac8b546?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        },
        {
            id: 2,
            ...
            price: '$79.99',
            image: 'https://images.unsplash.com/photo-1551288049-b1f3a0a9e3f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        },
        {
            id: 3,
            ...
            price: '$59.99',
            image: 'https://images.unsplash.com/photo-1581291518857-4e27b6d8a9fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        },
        {
            id: 4,
        ...
        },
        {
            ...
            price: '$29.99',
            image: 'https://images.unsplash.com/photo-1516321310762-4794370e6a66?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        },
    ];
    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-blue-900 items-stretch p-4 font-sans relative overflow-x-hidden">
            ...
            <div className="flex flex-col items-center justify-start p-4 sm:p-6 lg:p-10 max-h-full flex-1">
                {/* Search Input */}
                <div className="w-full max-w-3xl mt-16 mb-12 px-2 sm:px-4">
